...
class TestCowViewSaving(common.TransactionCase):
    ...
    def test_cow_complete_flow(self):
        ...
        self.base_view.write({'key': False, 'arch': '<div>Hi</div>'})
        self.inherit_view.write({'key': False, 'arch': '<div position="inside"> World</div>'})
        ...
        # 1  | Base      |  Hello  |     /      |     /    |  a
        # 3  | Base      |  Bye    |     1      |     /    |  a
        # 2  | Extension |  World  |     /      |     1    |  b
        # 4  | Extension |  World  |     1      |     3    |  b
