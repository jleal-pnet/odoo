...
QUnit.test('attachment test', function (assert) {
    assert.expect(11);
    ...
    $button.click();
    assert.notOk(form.$('.o_mail_chatter_attachments').hasClass('o_hidden'),
        "attachment widget should become visible after a click on the button");
    ...
    $button.click();
    assert.ok(form.$('.o_mail_chatter_attachments').hasClass('o_hidden'),
        "attachment widget should become invisible after a second click");
    form.destroy();
});
