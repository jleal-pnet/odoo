...
class Followers(models.Model):
    ...
    def _get_recipient_data(self, records, subtype_id, pids=None, cids=None):
        ...
        :return: list of recipient data which is a list of tuples containing
...
SELECT partner.id as pid, NULL AS cid, partner.partner_share as pshare, NULL as ctype,
...
UNION
SELECT NULL AS pid, channel.id AS cid, NULL AS pshare, channel.channel_type AS ctype,
