...
class Product(models.Model):
    ...
    membership = fields.Boolean(is_business_field = True, help='Check if the product is eligible for membership.')
    membership_date_from = fields.Date(string='Membership Start Date',
        is_business_field = True, help='Date from which membership becomes active.')
    membership_date_to = fields.Date(string='Membership End Date',
        is_business_field = True, help='Date until which membership remains active.')
