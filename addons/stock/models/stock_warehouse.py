...
class Orderpoint(models.Model):
    ...
    group_id = fields.Many2one(
        ...
        help="Moves created through this orderpoint will be put in this procurement group. If none is given, the moves generated by Stock supply rule will be grouped into one big picking.")
    company_id = fields.Many2one(
