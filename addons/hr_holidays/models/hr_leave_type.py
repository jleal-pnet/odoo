...
class HolidaysType(models.Model):
    ...
    limit = fields.Boolean('Exceed allocated days', help="If you select this check box, the system will allow the employees to ask for leaves without allocating some beforehand")
