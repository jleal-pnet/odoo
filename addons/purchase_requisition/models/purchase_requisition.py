...
class StockSupplyRule(models.Model):
    ...
    def _run_buy(self, product_id, product_qty, product_uom, location_id, name, origin, values):
        if product_id.purchase_requisition != 'tenders':
            return super(StockSupplyRule, self)._run_buy(product_id, product_qty, product_uom, location_id, name, origin, values)
    ...
    def _prepare_purchase_order(self, product_id, product_qty, product_uom, origin, values, partner):
        res = super(StockSupplyRule, self)._prepare_purchase_order(product_id, product_qty, product_uom, origin, values, partner)
    ...
    def _make_po_get_domain(self, values, partner):
        domain = super(StockSupplyRule, self)._make_po_get_domain(values, partner)
