...
class AccountReconcileModel(models.Model):
    ...
    show_force_tax_included = fields.Boolean(default=False, help='Technical field used to show the force tax included button')
    ...
    show_second_force_tax_included = fields.Boolean(default=False, help='Technical field used to show the force tax included button')
