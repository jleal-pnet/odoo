...
tour.register('rte', {
    ...
    run: function () {
        ...
        Wysiwyg.setRange($h1[0].firstChild, 0, $('p', this.$anchor)[0], 0);
    ...
    run: function () {
        Wysiwyg.setRange(this.$anchor[0].firstChild, 5, this.$anchor[0].firstChild, 10);
    ...
    run: function () {
        Wysiwyg.setRange(this.$anchor.prev()[0].firstChild, 3, this.$anchor[0].firstChild, 10);
    ...
    run: function () {
        Wysiwyg.setRange(this.$anchor.prev()[0].firstChild, 3, this.$anchor.parent("h1").next("p")[0].firstChild, 30);
        simulateClickEvent(this.$anchor.prev()[0], 'mouseup');
    }
}, {
    content: "open color dropdown",
    ...
    run: function () {
        var $node = this.$anchor.next("p");
        $node.html($node.html());
        Wysiwyg.setRangeFromNode($node[0]);
        Wysiwyg.setRange(this.$anchor.find('font:containsExact(ici)')[0].firstChild, 1, this.$anchor.next().next()[0].firstChild, 5);
    ...
    extra_trigger: '.o_editable.note-editable.o_dirty',
    run: function () {
        Wysiwyg.setRange(this.$anchor.find('font:first')[0].firstChild, 3, this.$anchor.next("p")[0].childNodes[2], 8);
    ...
    run: function () {
        ...
        Wysiwyg.setRange(p, p.textContent.length, p, p.textContent.length);
    ...
    run: function () {
        ...
        Wysiwyg.setRange(this.$anchor[0].firstChild, 7);
        simulateClickEvent(this.$anchor[0], 'mouseup');
    }
}, {
    content: "enter in ul",
