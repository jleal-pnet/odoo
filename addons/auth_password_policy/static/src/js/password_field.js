...
var PasswordField = fields.InputField.extend({
    ...
    /**
     * The password widget should only be used for the edition part as it's
     * only used in a list view, and the list view currently doesn't use
     * widgets for readonly contexts, only edition
     *
     * @override
     * @private
     */
    _renderReadonly: null,
    /**
